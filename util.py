...
def format_license(text):
    ...
    """
    license_plate_ = ''
    mapping = {0: dict_int_to_char, 1: dict_int_to_char, 2: dict_char_to_int, 3: dict_char_to_int, 4: dict_int_to_char, 5: dict_int_to_char, 6: dict_int_to_char, 7: dict_char_to_int}
    # , 7: dict_char_to_int, 8: dict_int_to_char, 9: dict_int_to_char,}
